...
public class BuscadorPalabras {
    public static void main(String[] args) {
        ...
        String rutaFichero = "PRG\\20250423\\palabrasParaBuscar.txt"; // nota para mi jjajaja thayron tienes que cambiar la ruta del fichero y obviamente crear uno con un texto para buscar las palabras
